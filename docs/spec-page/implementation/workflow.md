...
**1. Data Preparation**
First, construct a Location Payload object containing the data you wish to attest to. This payload must include the required base fields (`lp_version`, `srs`, `location_type`, `location`) and any optional composable fields (`event_timestamp`, `media_data`, etc.) relevant to your use case .
