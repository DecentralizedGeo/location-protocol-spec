...
- Understand **Spatial Reference Systems (SRS)** and [OGC Standards](https://www.ogc.org/standards-overview/). See [Spatial Reference Systems](../appendices/srs.md) for more information.
